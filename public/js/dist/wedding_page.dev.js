...
var myCountryCode = "in"; //Added Code By Sushanta Gupta
  ...
  return regeneratorRuntime.async(function fetch_ip$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        case 0:
          _context6.next = 2;
          return regeneratorRuntime.awrap(fetch(path).then(function (res) {
            return res.json();
          }).then(function (data) {
...
function fetchPrice() {
  var _price, userSessionDataObject, _price2, _userSessionDataObject;
    ...
    while (1) {
      switch (_context7.prev = _context7.next) {
        case 0:
          ...
          _context7.next = 3;
          return regeneratorRuntime.awrap(getData("weddingcards/country_pricing/prices/in"));

        case 3:
          _price = _context7.sent;
          _price = _price.data();
          userSessionDataObject = getLocalStorage();
          userSessionDataObject["priceData"] = _price;
          localStorage.setItem("userSessionData", JSON.stringify(userSessionDataObject));
        ...
        case 13:
          _price2 = _context7.sent;
          _price2 = _price2.data();
          console.log(_price2);
          _userSessionDataObject = getLocalStorage();
          _userSessionDataObject["priceData"] = _price2;
          localStorage.setItem("userSessionData", JSON.stringify(_userSessionDataObject));
    ...
    while (1) {
      switch (_context8.prev = _context8.next) {
        case 0:
          ...
          mySwiper = new Swiper(".swiper-container-popup", {
            effect: "coverflow",
            grabCursor: true,
            centeredSlides: true,
            slidesPerView: "auto",
