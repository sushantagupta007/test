...
function addEvent(eventName, eventDT, eventVenue, eventDate, eventTime) {
  ...
  let box = ` <div class="event-box" id="${event_count + 1}">
                                <div style="text-align: center; color:rgba(0,0,0,0.5); font-family: sans-serif;"><span class="event-box-head" id="event-box-head-${
                                  event_count + 1
                                ...
                                <div class=" event-details">
                                    <button class="event-details-button" style="display: flex;" id="edit-${
                                      event_count + 1
                                    }" onclick="editEvent(${
    event_count + 1
  })"><img src="./img/edit.png" alt="" style="width:18px; height:18px;"> Edit</button>
                                    <button class="event-details-button" style="display: flex;" id="delete-${
                                      event_count + 1
                                    }" onclick="deleteEvent(${
    event_count + 1
...
window.addEventListener("load", (event) => {
  ...
  /*loading event boxes*/
  if (userSessionDataObject["events"].length == 0) {
    $(".event-container-1").append(`
                <div id="add-event" class="event-box" onclick="addPopup()">
                    <div>
                        <div class="event-details"><img src="./img/add_icon.svg" alt=""></div>
